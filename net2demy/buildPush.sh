...
ssh sparkrunner 'echo "/space/hadoop/spark_home/bin/spark-submit --class \"demy.webReader.Execute\" --master yarn --executor-cores 1 --driver-cores 1 --num-executors 1 --deploy-mode cluster --name \"Net 2 demy import\" --driver-memory 520M --executor-memory 520M --conf \"spark.driver.userClassPathFirst=true\" --jars \"commons-compress-1.14.jar,commons-io-2.4.jar,xz-1.6.jar,jts-core-1.14.0.jar,gt-shapefile-17.1.jar,gt-main-17.1.jar,gt-referencing-17.1.jar,gt-metadata-17.1.jar,gt-api-17.1.jar,gt-opengis-17.1.jar,gt-data-17.1.jar,jsr-275-1.0-beta-2.jar,core-0.26.jar,gt-epsg-hsql-17.1.jar,hsqldb-2.3.0.jar,geograpgic-processing_2.11.jar\" \"/home/spark/scala-url-import_2.11-1.0.jar\" " > run.sh; chmod 700 run.sh'
